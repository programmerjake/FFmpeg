 ...
 */
typedef struct Smpte436mAncIterator
{
    uint16_t anc_packets_left;
    GetByteContext gb;
} Smpte436mAncIterator;
...
/**
 * An ANC packet as decoded from the payload of Smpte436mCodedAnc
 */
 ...
 */
int avpriv_smpte_436m_anc_append(struct AVPacket* pkt, int anc_packet_count, const Smpte436mCodedAnc* anc_packets);
