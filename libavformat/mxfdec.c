...
static const MXFCodecUL mxf_data_essence_container_uls[] = {
    ...
    { { 0x06,0x0e,0x2b,0x34,0x04,0x01,0x01,0x09,0x0d,0x01,0x03,0x01,0x02,0x0e,0x00,0x00 }, 16, AV_CODEC_ID_VANC_SMPTE_436M, "vbi_vanc_smpte_436M", 11 },
...
static int mxf_parse_structural_metadata(MXFContext *mxf)
{
    ...
    for (int i = 0; i < material_package->tracks_count; i++) {
        ...
        if (st->codecpar->codec_type == AVMEDIA_TYPE_VIDEO) {
            ...
            if (mxf->eia608_extract && st->codecpar->codec_id == AV_CODEC_ID_VANC_SMPTE_436M) {
